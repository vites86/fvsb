      ...
      <div class="partners">
        <ul style="text-align: left" class="regions">
          <li>
            ...
            <br> - <a href="#">Львівська область </a>
            <br> - <a href="#">Чернівецька область </a>
            <br>
          ...
          <li>
            ...
            <br> - <a href="#">Харківська область</a>
            <br> - <a href="#">Дніпропетровська область</a>
          ...
          <li>- <a href="#">Херсонська область</a>
          ...
          <li>- <a href="#">Запорізька область</a>
            <br> - <a href="#">Полтавська область</a>
            <br> - <a href="#">Кіровоградська область</a>
            <br> - <a href="#">Луганська область </a>
            <br>
